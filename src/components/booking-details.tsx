...
export function BookingDetails({ id, fresh }: { id: string; fresh?: boolean }) {
    ...
    <div className="space-y-5">
      ...
      <Card className="overflow-hidden">
        ...
        <p className="border-t border-slate-100 px-5 py-3 text-xs text-slate-500">
          ...
          {booking.mt.lastCheckedAt && <> · {t.confirmation.lastChecked}: <span className="ltr-nums">{new Date(booking.mt.lastCheckedAt).toLocaleTimeString(locale === "ar" ? "ar-SA-u-nu-latn" : "en-GB")}</span></>}
        </p>
      </Card>
