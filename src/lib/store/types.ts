 ...
 */
export type Collection = "users" | "userEmails" | "bookings" | "sandboxPackages" | "config" | "travellers" | "outbox" | "wallet" | "files" | "places" | "favorites" | "seasons" | "eventOrders" | "eventSeats" | "trainOrders" | "trainSeats" | "restaurantBookings" | "restaurantSlots" | "esimOrders" | "chats" | "aiUsage" | "tripPlans" | "notifications" | "reviews";
